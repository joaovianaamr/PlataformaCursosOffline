...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'cursos/:courseSlug/modulos/:m1/aulas/:lessonSlug/cortes/:chapterOrder', element: <ChapterPage /> },
      { path: 'cursos/:courseSlug/modulos/:m1/:m2/aulas/:lessonSlug/cortes/:chapterOrder', element: <ChapterPage /> },
